...
`docs/records/histories/` 用来记录已经完成的代码变更任务。纯问答、调研、分析类任务默认不需要记 history，除非最后确实改了仓库内容。
...
- 目录：`docs/records/histories/YYYY-MM/`
- 文件名：`YYYYMMDD-HHmm-task-slug.md`
- 模板：`docs/records/histories/template.md`

示例：

```text
docs/records/histories/
  2026-04/

...
func (fileAsset) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.FileAsset))
...
func (s fileAsset) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.FileAsset], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.FileAsset))
	...
	return &gormc.PagingResult[models.FileAsset]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s fileAsset) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.FileAsset], error) {
	if req == nil {

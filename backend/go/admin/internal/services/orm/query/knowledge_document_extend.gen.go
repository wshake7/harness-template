...
func (knowledgeDocument) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.KnowledgeDocument))
...
func (s knowledgeDocument) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.KnowledgeDocument], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.KnowledgeDocument))
	...
	var entities []*models.KnowledgeDocument
	...
	return &gormc.PagingResult[models.KnowledgeDocument]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s knowledgeDocument) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.KnowledgeDocument], error) {
	if req == nil {

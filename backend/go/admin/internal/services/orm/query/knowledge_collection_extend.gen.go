...
func (knowledgeCollection) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.KnowledgeCollection))
...
func (s knowledgeCollection) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.KnowledgeCollection], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.KnowledgeCollection))
	...
	var entities []*models.KnowledgeCollection
	...
	return &gormc.PagingResult[models.KnowledgeCollection]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s knowledgeCollection) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.KnowledgeCollection], error) {
	if req == nil {

...
func (agentSession) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.AgentSession))
...
func (s agentSession) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.AgentSession], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.AgentSession))
	...
	var entities []*models.AgentSession
	...
	return &gormc.PagingResult[models.AgentSession]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s agentSession) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.AgentSession], error) {
	if req == nil {

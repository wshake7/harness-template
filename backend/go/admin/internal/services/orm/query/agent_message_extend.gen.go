...
func (agentMessage) count(whereSelectors []func(*gorm.DB) *gorm.DB) (int64, error) {
	if Q.db == nil {
		return 0, errors.New("db is nil")
	}
	countDB := Q.db.Model(new(models.AgentMessage))
...
func (s agentMessage) PageWithPaging(req *paginationV1.PagingRequest) (*gormc.PagingResult[models.AgentMessage], error) {
	if req == nil {
	...
	listDB := Q.db.Model(new(models.AgentMessage))
	...
	var entities []*models.AgentMessage
	...
	return &gormc.PagingResult[models.AgentMessage]{
		Items: entities,
		Total: uint64(total),
	}, nil
}
...
func (s agentMessage) PageWithPagination(req *paginationV1.PaginationRequest) (*gormc.PagingResult[models.AgentMessage], error) {
	if req == nil {

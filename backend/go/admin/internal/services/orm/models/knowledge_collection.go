...
type KnowledgeCollection struct {
	...
	MetricType      string                `gorm:"column:metric_type;type:varchar(32);not null;default:'COSINE';comment:相似度度量类型 COSINE/IP/L2" json:"metricType"`
	IndexType       string                `gorm:"column:index_type;type:varchar(32);not null;default:'auto';comment:索引类型 auto/hnsw/ivf_flat" json:"indexType"`
	...
	Status          string                `gorm:"column:status;type:varchar(32);not null;default:'active';comment:集合状态 active/archived" json:"status"`
}

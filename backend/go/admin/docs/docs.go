...
const docTemplate = `{
        ...
        "/api/account/logout": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "登录 Token，或使用 cookie 中的 token",
                        "name": "Authorization",
                        "in": "header"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_router_logic.ReqDictEntryMatch"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/internal_router_logic.RespDictEntryMatch"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/internal_router_logic.RespJobScheduleOptions"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_router_logic.ReqSysUserCreate"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_router_logic.ReqSysUserBatchDelete"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/gormc.PagingResult-internal_router_logic_RespSysUser"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_router_logic.ReqSysUserUpdate"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "admin_internal_services_orm_models.SysUser": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "gormc.PagingResult-internal_router_logic_RespSysUser": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_router_logic.RespSysUser"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "internal_router_logic.ReqDictEntryMatch": {
            "type": "object",
            "required": [
                "codes"
            ],
        ...
        "internal_router_logic.ReqSysUserCreate": {
            "type": "object",
            "properties": {
                "isEnabled": {
                    "type": "boolean"
        ...
        "internal_router_logic.ReqSysUserUpdate": {
            "type": "object",
            "required": [
                "id"
            ],
        ...
        "internal_router_logic.RespDictEntryByCode": {
            "type": "object",
            "properties": {
                "entryLabel": {
                    "type": "string"
        ...
        "internal_router_logic.RespDictEntryMatch": {
            "type": "object",
            "additionalProperties": {
                "type": "array",
                "items": {
                    "$ref": "#/definitions/internal_router_logic.RespDictEntryByCode"
                }
            }
        },
        ...
        "internal_router_logic.RespJobScheduleOption": {
            "type": "object",
            "properties": {
                "label": {
                    "type": "string"
        ...
        "internal_router_logic.RespJobScheduleOptions": {
            "type": "object",
            "properties": {
                "defaultTaskQueue": {
                    "type": "string"

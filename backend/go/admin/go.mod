...
require (
	...
	github.com/cloudwego/eino-ext/components/document/transformer/splitter/markdown v0.0.0-20260521063832-407552a64b76
	...
	github.com/cloudwego/eino-ext/components/tool/duckduckgo/v2 v2.0.0-20260523100706-3a34358d6fd1

...
VALUES
    (
        ...
        '',
        0,
        '<Tag color="success">${EntryLabel}</Tag>',
        '启用',
        '1',
        '',
        1
    ...
    (
        ...
        '',
        0,
        '<Tag color="error">${EntryLabel}</Tag>',
        '停用',
        '0',
        '',
        1
    ...
    (
        ...
        '',
        0,
        '<Tag color="green">${EntryLabel}</Tag>',
        '目录',
        'CATALOG',
        '',
        2
    ...
    (
        ...
        '',
        0,
        '<Tag color="purple">${EntryLabel}</Tag>',
        '按钮',
        'BUTTON',
        '',
        2
    ...
    (
        ...
        '',
        0,
        '<Tag color="orange">${EntryLabel}</Tag>',
        '外链',
        'LINK',
        '',
        2
...
VALUES
    (
        ...
        'root',
        '',
        '$2a$04$ASoVUxXahEpdD9.dxfwsHuUw3PqQ/yAZ0gD2KnqtMAqSGZ4VZCSVO',
        ''
    ),
    (
        2,
        '2026-05-06 14:13:43.159636+08',
        '2026-05-06 14:13:43.159636+08',
        '',
        0,
        0,
...
VALUES
    (
        1,
        '2026-05-09 15:44:29.247468+08',
        '2026-05-09 17:31:30.430037+08',
        1,
        1,
        0,
        '',
...
VALUES
    (
        2,
        '2026-05-09 16:01:45.414731+08',
        '2026-05-09 17:54:40.486485+08',
        1,
        1,
        0,
        '',
        1,
        '{"icon": "SettingOutlined", "order": 1, "hidden": false}',
        't',
        0,
        'CATALOG',
        '/system',
...
VALUES
    (
        3,
        '2026-05-09 16:13:02.748554+08',
        '2026-05-10 20:06:34.713589+08',
        1,
        1,
        0,
        '',
        -2,
        '{"icon": "", "order": -2, "hidden": false}',
        't',
        0,
        'MENU',
...
VALUES
    (
        4,
        '2026-05-10 20:10:00.656317+08',
        '2026-05-10 20:10:45.771044+08',
        1,
        1,
        0,
        '',
        3,
        '{"icon": "ReconciliationOutlined", "order": 3, "hidden": false}',
        't',
        0,
        'CATALOG',
        '/logger',
...
VALUES
    (
        5,
        '2026-05-09 16:42:05.166618+08',
        '2026-05-10 19:54:52.382881+08',
        1,
        1,
        0,
        '',
...
VALUES
    (
        6,
        '2026-05-09 16:42:36.997454+08',
        '2026-05-10 19:54:57.037816+08',
        1,
        1,
        0,
        '',
...
VALUES
    (
        7,
        '2026-05-09 16:49:51.215257+08',
        '2026-05-10 20:28:47.004123+08',
        1,
        1,
        0,
        '',
        2,
        '{"icon": "UserOutlined", "order": 2, "hidden": false}',
        't',
        0,
        'CATALOG',
        '/account',
...
VALUES
    (
        8,
        '2026-05-09 16:50:35.892181+08',
        '2026-05-09 17:55:29.888606+08',
        1,
        1,
        0,
        '',
...
VALUES
    (
        9,
        '2026-05-10 17:38:27.019193+08',
        '2026-05-10 20:06:43.984546+08',
        1,
        1,
        0,
        '',
        -1,
        '{"icon": "", "order": -1, "hidden": false}',
        't',
        0,
        'MENU',
        '/system/resource/api',
...
VALUES
    (
        10,
        '2026-05-09 16:17:20.233627+08',
        '2026-05-10 20:10:15.368034+08',
        1,
        1,
        0,
        '',
        0,
        '{"icon": "", "order": 0, "hidden": false}',
        't',
        0,
        'MENU',
        '/logger/api/log',
...
VALUES
    (
        11,
        '2026-05-10 20:28:36.585473+08',
        '2026-05-10 20:28:36.587573+08',
        1,
        1,
        0,
        '',
...
VALUES
    (
        ...
        '',
        4,
        '{"icon": "ScheduleOutlined", "order": 4, "hidden": false}',
        't',
        0,
        'CATALOG',
        '/job',
...
VALUES
    (
        ...
        '',
        5,
        '{"icon": "BookOutlined", "order": 5, "hidden": false}',
        't',
        0,
        'CATALOG',
        '/knowledge',
...
VALUES
    (58, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/collection/list', 'POST'),
    (59, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/collection/detail', 'POST'),
    (60, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/collection/create', 'POST'),
    (61, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/collection/update', 'POST'),
    (62, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/collection/del', 'POST'),
    (63, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/document/list', 'POST'),
    (64, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/document/listByCollection', 'POST'),
    (65, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/document/detail', 'POST'),
    (66, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/document/create', 'POST'),
    (67, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/document/update', 'POST'),
    (68, NULL, NULL, 0, 0, 0, '', 0, TRUE, 0, 'knowledge', '/api/knowledge/document/del', 'POST');
...
VALUES
    (57, NULL, NULL, 0, 0, 0, 17, 58, 0),
    (58, NULL, NULL, 0, 0, 0, 17, 59, 0),
    (59, NULL, NULL, 0, 0, 0, 17, 60, 0),
    (60, NULL, NULL, 0, 0, 0, 17, 61, 0),
    (61, NULL, NULL, 0, 0, 0, 17, 62, 0),
    (62, NULL, NULL, 0, 0, 0, 17, 63, 0),
    (63, NULL, NULL, 0, 0, 0, 17, 64, 0),
    (64, NULL, NULL, 0, 0, 0, 17, 65, 0),
    (65, NULL, NULL, 0, 0, 0, 17, 66, 0),
    (66, NULL, NULL, 0, 0, 0, 17, 67, 0),
    (67, NULL, NULL, 0, 0, 0, 17, 68, 0);

INSERT INTO
    "public"."casbin_rule" ("ptype", "v0", "v1", "v2")
VALUES
    ('p', 'role:root', '/api/knowledge/collection/list', 'POST'),
    ('p', 'role:root', '/api/knowledge/collection/detail', 'POST'),
    ('p', 'role:root', '/api/knowledge/collection/create', 'POST'),
    ('p', 'role:root', '/api/knowledge/collection/update', 'POST'),
    ('p', 'role:root', '/api/knowledge/collection/del', 'POST'),
    ('p', 'role:root', '/api/knowledge/document/list', 'POST'),
    ('p', 'role:root', '/api/knowledge/document/listByCollection', 'POST'),
    ('p', 'role:root', '/api/knowledge/document/detail', 'POST'),
    ('p', 'role:root', '/api/knowledge/document/create', 'POST'),
    ('p', 'role:root', '/api/knowledge/document/update', 'POST'),
    ('p', 'role:root', '/api/knowledge/document/del', 'POST');
...
VALUES
    (15, '2026-05-23 00:00:00+08', '2026-05-23 00:00:00+08', 1, 1, 0, 1, 16, 0),
    (16, '2026-05-23 00:00:00+08', '2026-05-23 00:00:00+08', 1, 1, 0, 1, 17, 0);
...
VALUES
    (58, NULL, NULL, 0, 0, 0, 1, 58, 0),
    (59, NULL, NULL, 0, 0, 0, 1, 59, 0),
    (60, NULL, NULL, 0, 0, 0, 1, 60, 0),
    (61, NULL, NULL, 0, 0, 0, 1, 61, 0),
    (62, NULL, NULL, 0, 0, 0, 1, 62, 0),
    (63, NULL, NULL, 0, 0, 0, 1, 63, 0),
    (64, NULL, NULL, 0, 0, 0, 1, 64, 0),
    (65, NULL, NULL, 0, 0, 0, 1, 65, 0),
